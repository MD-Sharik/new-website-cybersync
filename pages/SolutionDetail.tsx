...
const SOLUTIONS_DATA: Record<string, Solution> = {
  ...
  'ai': {
    ...
    fullDesc: 'We push the boundaries of what is possible with Enterprise AI. Our flagship offering in development is the RAG AI, a private AI wrapper ensuring data privacy similar to watsonx.ai. We also engineer sophisticated Natural Language Processing (NLP) models and Computer Vision systems. We help you move from AI proof-of-concept to production-grade deployment.',
